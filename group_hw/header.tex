...
% limit macros for ease
\newcommand{\lnti}{\lim_{n \to \infty}}
\newcommand*{\lxta}[1]{\lim_{x \to #1}}

%very random specific use case
\newcommand{\displayand}{\hspace{2em} \text{and} \hspace{2em}}
